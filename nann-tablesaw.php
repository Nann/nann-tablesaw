...
Description: Tablesaw for WordPress Table
...
function tablesaw_script() {
    ...
    if(is_front_page() or ( ! empty( $txt_tablesaw ) )){
        wp_enqueue_script( 'tablesaw-loadfont-js', plugin_dir_url( __FILE__ ) . 'assets/js/loadfont.js' , array('jquery'), '2017-3', true );
        wp_enqueue_script( 'tablesaw-init-js', plugin_dir_url( __FILE__ ) . 'assets/js/tablesaw-init.js' , array('jquery'), '2017-3', true );
        wp_enqueue_script( 'tablesaw-jquery-js', plugin_dir_url( __FILE__ ) . 'assets/js/tablesaw.stackonly.jquery.js' , array('jquery'), '2017-3', true );
        wp_enqueue_script( 'tablesaw-stackonly-js', plugin_dir_url( __FILE__ ) . 'assets/js/tablesaw.stackonly.js' , array('jquery'), '2017-3', true );

        wp_enqueue_style( 'tablesaw-demo-css', plugin_dir_url( __FILE__ ) . 'assets/css/demo.css' , array() );
        wp_enqueue_style( 'tablesaw-demohead-css', plugin_dir_url( __FILE__ ) . 'assets/css/demohead.css' , array() );
        wp_enqueue_style( 'tablesaw-stackonly-css', plugin_dir_url( __FILE__ ) . 'assets/css/tablesaw.stackonly.css' , array() );
    }
}
